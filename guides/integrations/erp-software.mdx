...
In their case, it is the brand's responsibility to ingest Frate's data, and create the desired records in the ERP system tailored to their internal processes.
